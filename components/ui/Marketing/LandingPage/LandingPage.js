                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                            <div>
                                ...
                                <p className="mt-3  text-blueGray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                            ...
                            <div className="px-4 py-8 sm:px-10">
                                <div>
                                    <div className="mt-1 gap-3">
                                        <div>
                                            <a href="#" className="w-full flex justify-space-between items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-md font-medium text-blueGray-500 hover:bg-gray-50">
                                        ...
                                        {/* <div>
                                            <a href="#" className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                ...
                                {/* <div className="mt-6">
                                    <form action="#" method="POST" className="space-y-6">
                                        ...
                                        <div>
                                            <label for="mobile-or-email" className="sr-only">Mobile number or email</label>
